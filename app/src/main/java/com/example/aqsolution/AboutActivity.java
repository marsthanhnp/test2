...
public class AboutActivity extends YouTubeBaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        youTubePlayerView=findViewById(R.id.ytb_about);
...
//        youTubePlayer.cueVideo("qyuvIbUFtPQ&list=PLUS4wIWtP11mRLAZcirszqjNLdk3kWe0Q&ab_channel=AnIsHere");
        youTubePlayer.cueVideo("3uACZITLUPk");
    ...
    public void onInitializationFailure(YouTubePlayer.Provider provider, YouTubeInitializationResult youTubeInitializationResult) {
        if (youTubeInitializationResult.isUserRecoverableError()){
            youTubeInitializationResult.getErrorDialog(AboutActivity.this,REQUEST_VIDEO);
        }else{
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode==REQUEST_VIDEO){
            youTubePlayerView.initialize(API_KEY_YOUTUBE,AboutActivity.this);
        }
